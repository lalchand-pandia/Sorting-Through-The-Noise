...
for model in model_list:
	...
	for row in reader:
		...
		if int(row['count_attractors']) == 4:
			#if row['target_occupation'].lower() == item_list[0].lower():
			correct_4_attractor+=float(row['relative_prob'])
			count_4_attractor+=1
		if int(row['count_attractors']) == 5:
			#if row['target_occupation'].lower() == item_list[0].lower():
			correct_5_attractor+=float(row['relative_prob'])
			count_5_attractor+=1
	...
	for row in reader:
		...
		if int(row['count_attractors']) == 4:
			#if row['target_occupation'].lower() == item_list[0].lower():
			correct_4_attractor_single_entity+=float(row['relative_prob'])
				#correct+=1
		...
		if int(row['count_attractors']) == 5:
			#if row['target_occupation'].lower() == item_list[0].lower():
			correct_5_attractor_single_entity+=float(row['relative_prob'])
				#correct+=1
